  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#080d14] flex flex-col items-center justify-center p-4 relative overflow-hidden transition-colors duration-300">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none -z-10">
        <div className="absolute top-[-15%] right-[-10%] w-[50%] h-[50%] bg-[#90E0EF]/20 dark:bg-[#00B4D8]/10 rounded-full blur-[120px]" />
        <div className="absolute bottom-[-15%] left-[-10%] w-[50%] h-[50%] bg-[#00B4D8]/10 dark:bg-[#90E0EF]/5 rounded-full blur-[120px]" />
      </div>

      <div className="w-full max-w-md z-10">
        <div className="flex flex-col items-center mb-10 transform transition-all duration-700">
          <div className="w-20 h-20 bg-white dark:bg-slate-900 rounded-[2rem] shadow-2xl shadow-[#00B4D8]/10 dark:shadow-[#00B4D8]/5 flex items-center justify-center mb-6 border border-[#90E0EF]/30 dark:border-slate-800">
          ...
          <p className="text-slate-400 dark:text-slate-500 font-bold text-[10px] uppercase tracking-[0.3em] mt-3">Account Recovery System</p>
        </div>

        <div className="bg-white dark:bg-slate-900 rounded-[2.5rem] shadow-[0_30px_70px_-20px_rgba(0,180,216,0.15)] dark:shadow-none border border-[#00B4D8]/5 dark:border-slate-800 p-10 overflow-hidden">
          {errorMsg && (
            <div className="mb-6 p-4 rounded-2xl bg-red-50 dark:bg-red-500/10 border border-red-100 dark:border-red-500/20 flex flex-col items-center text-center gap-3 animate-in fade-in zoom-in-95 duration-300">
          ...
          {step === 'email' && (
            <form onSubmit={handleSendCode} className="space-y-6">
              <p className="text-sm text-slate-500 dark:text-slate-400 font-medium text-center px-2">
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full bg-slate-50 dark:bg-slate-800/40 border-slate-200 dark:border-slate-700 text-slate-800 dark:text-slate-200 rounded-2xl px-5 py-4 pl-12 text-sm focus:ring-2 focus:ring-[#00B4D8]/20 focus:border-[#00B4D8] dark:focus:bg-slate-950 transition-all"
            ...
            <form onSubmit={handleVerifyCode} className="space-y-6">
              ...
              <div className="space-y-1.5">
                ...
                <input
                  ...
                  className="w-full bg-slate-50 dark:bg-slate-800/40 border-slate-200 dark:border-slate-700 text-slate-800 dark:text-slate-200 rounded-2xl px-5 py-4 text-center text-2xl font-black tracking-[0.5em] focus:ring-2 focus:ring-[#00B4D8]/20 focus:border-[#00B4D8] dark:focus:bg-slate-950 transition-all"
                  placeholder="000000"
                />
              </div>
              <button
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full bg-slate-50 dark:bg-slate-800/40 border-slate-200 dark:border-slate-700 text-slate-800 dark:text-slate-200 rounded-2xl px-5 py-4 text-sm focus:ring-2 focus:ring-[#00B4D8]/20 focus:border-[#00B4D8] dark:focus:bg-slate-950 transition-all"
                    placeholder="••••••••"
                  />
                  <button
                    type="button"
                    onClick={() => setShowPassword(!showPassword)}
                    className="absolute right-4 top-1/2 -translate-y-1/2 text-slate-400 dark:text-slate-500 hover:text-[#00B4D8] transition-colors"
                  >
          ...
          {step === 'success' && (
            <div className="flex flex-col items-center text-center animate-in zoom-in-95 duration-500">
              <div className="w-20 h-20 bg-emerald-50 dark:bg-emerald-500/10 text-emerald-500 dark:text-emerald-400 rounded-[2rem] flex items-center justify-center mb-6 shadow-lg shadow-emerald-500/10">
                <CheckCircle2 size={40} />
              </div>
              <h3 className="text-2xl font-black text-slate-800 dark:text-white tracking-tight mb-2">Security Updated!</h3>
