    ...
    <div className="min-h-screen bg-white dark:bg-[#080d14] flex flex-col items-center justify-center p-4 relative overflow-hidden transition-colors duration-300">
      ...
      <div className="w-full max-w-md z-10 px-4">
        <div className="flex flex-col items-center mb-10 transform transition-all duration-700">
          ...
          <p className="text-slate-400 dark:text-slate-500 font-bold text-[10px] uppercase tracking-[0.3em] mt-3 text-center">Register for Administrative Access</p>
        </div>
        ...
        <div className="mt-8 text-center p-6 bg-[#00B4D8]/5 dark:bg-[#00B4D8]/10 rounded-[2rem] border border-[#00B4D8]/10 dark:border-[#00B4D8]/20 max-w-xs mx-auto">
          <p className="text-[10px] font-bold text-slate-500 dark:text-slate-400 leading-relaxed uppercase tracking-tighter">
