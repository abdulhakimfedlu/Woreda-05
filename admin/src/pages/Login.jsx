...
export function Login() {
  return (
    <div className="min-h-screen bg-white flex flex-col items-center justify-center p-4 relative overflow-hidden transition-colors duration-300">
          ...
          <SignIn
            appearance={{
              elements: {
                ...
                socialButtonsBlockButton: "border border-slate-200 hover:bg-slate-50 transition-all rounded-xl h-14 w-full gap-3 shadow-sm",
                ...
                formFieldInput: "bg-slate-50 border-slate-200 text-slate-800 rounded-2xl px-5 py-4 text-sm focus:ring-2 focus:ring-[#00B4D8]/20 focus:border-[#00B4D8] focus:bg-white transition-all",
                ...
                otpCodeFieldInput: "border-slate-200 focus:border-[#00B4D8] focus:ring-[#00B4D8]/20 text-slate-800",
              },
              layout: {
