  ...
  return (
    ...
    >
      <div className="flex items-center gap-4 mb-6">
        ...
        <div>
          <h2 className="text-2xl font-black text-slate-800 tracking-tighter group-hover:text-brand transition-colors duration-300">{category.name}</h2>
        </div>
      </div>
      ...
      <div className="flex-1">
        <p className="text-sm font-medium text-slate-500 leading-relaxed mb-6 line-clamp-3">
          {category.description || 'Explore the various services provided under this administrative category.'}
        </p>
      </div>
      ...
      <div className="max-w-[1400px] mx-auto px-6 sm:px-8 lg:px-12">
        ...
        {loading ? (
          <div className="py-20 text-center">
            <p className="text-2xl font-black text-black/20 uppercase tracking-widest animate-pulse">Loading Directory...</p>
          </div>
        ) : (
          <div className="grid lg:grid-cols-2 xl:grid-cols-3 gap-8">
            {filteredCategories.length > 0 ? (
              ...
              <div className="col-span-full py-20 text-center">
                <p className="text-2xl font-black text-black/20 uppercase tracking-widest">No categories found matching your search</p>
              </div>
            )}
          </div>
        )}
